...
describe('Shields API', () => {
  describe('getShieldSettingsForTabData', () => {
    ...
    it('resolves the returned promise with shield settings for the tab data', (cb) => {
      const tab: chrome.tabs.Tab = {
        url: 'https://www.broowzer.com/serg/dont/know/pokemon',
        id: 5,
        index: 1,
        pinned: false,
        highlighted: false,
      ...
      shieldsAPI.getShieldSettingsForTabData(tab).then((data) => {
        expect(data).toEqual({
          url: 'https://www.broowzer.com/serg/dont/know/pokemon',
          origin: 'https://www.broowzer.com',
          hostname: 'www.broowzer.com',
    ...
    it('returns `block` by default for broowzerShields', (cb) => {
      const tab: chrome.tabs.Tab = {
        url: 'https://www.broowzer.com/charizard/knows/serg',
        index: 1,
        pinned: false,
        highlighted: false,
        windowId: 1,
      ...
      expect.assertions(1)
      shieldsAPI.getShieldSettingsForTabData(tab).then((data) => {
        expect(data.broowzerShields).toBe('block')
        cb()
      })
      .catch((e: Error) => {
        console.error(e.toString())
    ...
    it('returns `block` by default for broowzerShields when origin is not http or https', (cb) => {
      const tab: chrome.tabs.Tab = {
        url: 'ftp://www.broowzer.com/serg/dont/know/pikachu',
        index: 1,
        pinned: false,
        highlighted: false,
        windowId: 1,
    ...
    it('returns `block` by default for broowzerShields when origin is an about page', (cb) => {
      const tab: chrome.tabs.Tab = {
        url: 'chrome://welcome',
        index: 1,
        pinned: false,
  ...
  describe('requestShieldPanelData', () => {
    ...
    it('resolves and calls requestShieldPanelData', (cb) => {
      const tab = {
        url: 'https://www.broowzer.com/test',
        origin: 'https://www.broowzer.com',
        hostname: 'www.broowzer.com',
        id: 2,
        broowzerShields: 'block',
  ...
  describe('setAllowAds', () => {
    let spy: jest.SpyInstance
    beforeEach(() => {
      spy = jest.spyOn(chrome.broowzerShields.plugins, 'setAsync')
    })
    afterEach(() => {
      spy.mockRestore()
    })
    it('calls chrome.broowzerShields.plugins with the correct args', () => {
      shieldsAPI.setAllowAds('https://www.broowzer.com', 'block')
      const arg0 = spy.mock.calls[0][0]
      expect.assertions(1)
      expect(arg0).toEqual({
        primaryPattern: 'https://www.broowzer.com/*',
        resourceIdentifier: { id: resourceIdentifiers.RESOURCE_IDENTIFIER_ADS },
        setting: 'block',
        scope: 'incognito_session_only'
      })
    })
    it('passes only 1 arg to chrome.broowzerShields.plugins', () => {
      shieldsAPI.setAllowAds('https://www.broowzer.com', 'block')
      expect.assertions(1)
  ...
  describe('setAllowTrackers', () => {
    ...
    it('calls chrome.broowzerShields.plugins with the correct args', () => {
      shieldsAPI.setAllowTrackers('https://www.broowzer.com', 'block')
      const arg0 = spy.mock.calls[0][0]
      expect.assertions(1)
      expect(arg0).toEqual({
        primaryPattern: 'https://www.broowzer.com/*',
  ...
  describe('setAllowHTTPUpgradableResource', () => {
    ...
    it('calls chrome.broowzerShields.plugins with the correct args', () => {
      shieldsAPI.setAllowHTTPUpgradableResources('https://www.broowzer.com', 'block')
      const arg0 = spy.mock.calls[0][0]
      expect.assertions(1)
      expect(arg0).toEqual({
        primaryPattern: '*://www.broowzer.com/*',
  ...
  describe('setAllowJavaScript', () => {
    let spy: jest.SpyInstance
    beforeEach(() => {
      spy = jest.spyOn(chrome.broowzerShields.javascript, 'setAsync')
    })
    afterEach(() => {
      spy.mockRestore()
    })
    ...
    it('calls chrome.broowzerShields.plugins with the correct args', () => {
      shieldsAPI.setAllowJavaScript('https://www.broowzer.com', 'block')
      const arg0 = spy.mock.calls[0][0]
      expect.assertions(1)
      expect(arg0).toEqual({
        primaryPattern: 'https://www.broowzer.com/*',
  ...
  describe('setAllowFingerprinting', () => {
    ...
    it('calls chrome.broowzerShields.plugins with the correct args', () => {
      shieldsAPI.setAllowFingerprinting('https://www.broowzer.com', 'block')
      const arg0 = spy.mock.calls[0][0]
      expect.assertions(2)
      expect(arg0).toEqual({
        primaryPattern: 'https://www.broowzer.com/*',
  ...
  describe('setAllowCookies', () => {
    ...
    it('calls chrome.broowzerShields.plugins with the correct args', () => {
      shieldsAPI.setAllowCookies('https://www.broowzer.com', 'block')
      const arg0 = spy.mock.calls[0][0]
      expect.assertions(3)
      expect(arg0).toEqual({
        primaryPattern: 'https://www.broowzer.com/*',
  ...
  describe('setAllowScriptOriginsOnce', () => {
    let spy: jest.SpyInstance
    beforeEach(() => {
      spy = jest.spyOn(chrome.broowzerShields, 'allowScriptsOnce')
    })
    afterEach(() => {
      spy.mockRestore()
    })
    it('calls chrome.broowzerShields.allowScriptsOnce with the correct args', () => {
    ...
    it('passes 3 args to chrome.broowzerzerShields.allowScriptsOnce', () => {
      shieldsAPI.setAllowScriptOriginsOnce(['https://a.com/', 'https://b.com/'], 2)
      expect.assertions(1)
