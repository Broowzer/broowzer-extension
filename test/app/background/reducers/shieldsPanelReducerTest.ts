...
describe('broowzerShieldsPanelReducer', () => {
  ...
  describe('ON_COMMITTED', () => {
    ...
    it('calls resetNoScriptInfo when isMainFrame is true', () => {
      ...
      expect(resetNoScriptInfoSpy.mock.calls[0][2]).toBe('https://www.broowzer.com')
    })
  ...
  const origin = 'https://broowzer.com'
  ...
  describe('SHIELDS_TOGGLED', () => {
    ...
    let setAllowBroowzerShieldsSpy: jest.SpyInstance
    beforeEach(() => {
      reloadTabSpy = jest.spyOn(tabsAPI, 'reloadTab')
      setAllowBroowzerShieldsSpy = jest.spyOn(shieldsAPI, 'setAllowBroowzerShields')
    })
    afterEach(() => {
      reloadTabSpy.mockRestore()
      setAllowBroowzerShieldsSpy.mockRestore()
    })
    it('should call setAllowBroowzerShields', () => {
      expect(
        shieldsPanelReducer(state, {
          type: types.SHIELDS_TOGGLED,
          setting: 'allow'
        })).toEqual(state)
      expect(setAllowBroowzerShieldsSpy).toBeCalledWith(origin, 'allow')
    })
  })
    ...
    it('increments for JS blocking', () => {
      let nextState = shieldsPanelReducer(state, {
        ...
        details: {
          blockType: 'javascript',
          tabId: 2,
          subresource: 'https://test.broowzer.com/index.js'
        }
      })
      ...
      expect(nextState).toEqual({
        ...
        tabs: {
          2: {
            ...
            cookies: 'block',
            noScriptInfo: {
              'https://test.broowzer.com/': { actuallyBlocked: true, willBlock: true }
            },
            trackersBlockedResources: [],
            adsBlockedResources: [],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [],
            javascriptBlockedResources: [ 'https://test.broowzer.com/index.js' ]
          }
        },
        windows: {
          1: 2
    ...
    it('increments for fingerprinting blocked', () => {
      let nextState = shieldsPanelReducer(state, {
        ...
        details: {
          ...
          tabId: 2,
          subresource: 'https://test.broowzer.com'
        }
      })
      expect(nextState).toEqual({
        currentWindowId: 1,
        tabs: {
          2: {
            ...
            trackersBlockedResources: [],
            adsBlockedResources: [],
            fingerprintingBlockedResources: [ 'https://test.broowzer.com' ],
            httpsRedirectedResources: [],
            javascriptBlockedResources: []
          }
        },
    ...
    it('increases same count consecutively', () => {
      ...
      expect(nextState).toEqual({
        ...
        tabs: {
          2: {
            ...
            noScriptInfo: {},
            trackersBlockedResources: [],
            adsBlockedResources: [ 'https://test.broowzer.com' ],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [],
            javascriptBlockedResources: []
          }
      ...
      nextState = shieldsPanelReducer(nextState, {
        ...
        details: {
          blockType: 'ads',
          tabId: 2,
          subresource: 'https://test2.broowzer.com'
        }
      })
      expect(nextState).toEqual({
        currentWindowId: 1,
        tabs: {
          2: {
            ...
            trackersBlockedResources: [],
            adsBlockedResources: [
              'https://test.broowzer.com',
              'https://test2.broowzer.com'
            ],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [],
            javascriptBlockedResources: []
      ...
      expect(nextState).toEqual({
        ...
        tabs: {
          2: {
            ...
            cookies: 'block',
            noScriptInfo: {},
            trackersBlockedResources: [ 'https://test.broowzer.com' ],
            adsBlockedResources: [ 'https://test.broowzer.com' ],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [],
            javascriptBlockedResources: []
      ...
      expect(nextState).toEqual({
        ...
        tabs: {
          2: {
            ...
            adsBlockedResources: [ 'https://test.broowzer.com' ],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [ 'https://test.broowzer.com' ],
            javascriptBlockedResources: []
          }
        },
        windows: {
