...
import ShieldsInterfaceControls, { Props } from '../../../../app/components/broowzerShields/interfaceControls'
...
describe('InterfaceControls component', () => {
  ...
  it('renders the component', () => {
    ...
    const assertion = wrapper.find('#broowzerShieldsInterfaceControls').length === 1
