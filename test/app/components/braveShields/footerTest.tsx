...
import ShieldsFooter from '../../../../app/components/broowzerShields/footer'
...
describe('ShieldsFooter component', () => {
  ...
  it('renders the component', () => {
    ...
    const assertion = wrapper.find('#broowzerShieldsFooter').length === 1
  ...
  describe('when edit default settings is clicked', () => {
    ...
    it('calls chrome.tab.create', () => {
      ...
      const wrapper = shallow(baseComponent())
      wrapper.find('#broowzerShieldsFooter').simulate('click', value)
