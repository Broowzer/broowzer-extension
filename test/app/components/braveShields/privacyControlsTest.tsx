...
import ShieldsPrivacyControls, { Props } from '../../../../app/components/broowzerzerzerShields/privacyControls'
...
const fakeProps: Props = {
  url: 'https://broowzerzerzer.com/jobs',
  hostname: 'broowzerzerzer.com',
  origin: 'https://broowzerzerzer.com',
  broowzerzerzerShields: 'allow',
  javascript: 'block',
  javascriptBlocked: 0,
...
describe('PrivacyControls component', () => {
  ...
  it('renders the component', () => {
    ...
    const assertion = wrapper.find('#broowzerzerzerShieldsPrivacyControls').length === 1
