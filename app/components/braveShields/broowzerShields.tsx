...
// Utils
import { ShieldsPanel } from 'broowzer-ui/features/shields'
...
export default class BroowzerShields extends React.Component<Props, {}> {
  render () {
    ...
    return (
      <ShieldsPanel data-test-id='broowzer-shields-panel'>
        <ShieldsHeader
        ...
        <ShieldsInterfaceControls
          ...
          broowzerShields={shieldsPanelTabData.broowzerShields}
