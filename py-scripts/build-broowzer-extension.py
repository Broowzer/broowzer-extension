...
def main():
  parser = argparse.ArgumentParser(description='Build Broowzer extension')
  parser.add_argument('--output_dir')
  parser.add_argument('--broowzer_extension_dir')
  parser.add_argument('--build_dir')
  args = parser.parse_args()

  broowzer_extension_dir = os.path.abspath(args.broowzer_extension_dir)
  build_dir = os.path.abspath(args.build_dir)
  output_dir = os.path.abspath(args.output_dir)

  os.chdir(broowzer_extension_dir)
